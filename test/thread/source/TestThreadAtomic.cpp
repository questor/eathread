...
int TestThreadAtomic()
{
	...
	{ // Initial tests of 128 bit atomics
			...
			EASTL_ALIGN(128) int64_t dest128[2]             = { 0, 0 };
			EASTL_ALIGN(128) int64_t value128[2]            = { 1, 2 };
			EASTL_ALIGN(128) int64_t condition128Fail[2]    = { 4, 5 };
			EASTL_ALIGN(128) int64_t condition128Succeed[2] = { 0, 0 };
			bool    result;

...
//
	...
	#define EATHREAD_LIKELY(x) EASTL_LIKELY(x)
	#define EATHREAD_UNLIKELY(x) EASTL_UNLIKELY(x)
#endif
///////////////////////////////////////////////////////////////////////////////
...
//
// Example usage:
//     gMessageServer.GetMessageQueue().getAllocator().setName(EATHREAD_ALLOC_PREFIX "MessageSystem/Queue");
//
